...
var fill_width = (hp_current / hp_max) * sprite_get_width(FullHealthBar);
...
draw_sprite_part_ext(FullHealthBar, 0, 0, 0, fill_width, sprite_get_height(FullHealthBar), 
                     bar_x, bar_y, stretch_factor, 1.5, fill_color, 1);

// Then draw empty health bar above the filled one
draw_sprite_ext(EmptyHealthBar, 0, bar_x, bar_y, stretch_factor, 1.5, 0, c_white, 1);